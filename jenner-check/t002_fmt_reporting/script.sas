...
/* exercise the compiled formats against a small mock dataset */
data fmt_demo;
  input dose age initial_pt_wt dx $;
  datalines;
30  17 35  D595
90  42 55  D593
1200 70 120 G7000
...
proc print data=fmt_demo;
  format dose dose_fmt. age age_fmt. initial_pt_wt pt_wt_fmt. dx $dx_fmt.;
run;
